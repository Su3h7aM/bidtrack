...
# Removed Optional from typing import as it's no longer used after this change
...
def create_bids_figure(bids_df_display: pd.DataFrame, min_quote_price: float | None = None) -> go.Figure:
