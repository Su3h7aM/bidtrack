...
from src.services.dataframes import get_bids_dataframe # Updated import
...
def display_bids_tab(bid_repo, bidding_repo, item_repo, bidder_repo):
    ...
    bid_column_config = {
        ...
        "price": st.column_config.NumberColumn("Preço Ofertado", format="R$ %.2f", min_value=0.01, required=True, help="Valor do lance ofertado."),
        "notes": st.column_config.TextColumn("Notas do Lance", help="Observações sobre o lance (opcional)."),
